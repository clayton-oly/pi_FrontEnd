...
// Alterando a Interface de TokenState para UserState, e adicione o campo ID
export interface UserState {
    tokens: string,
    id: string
}

// Alterando a Inicialiazação do State adicionando o campo ID
const initialState = {
    tokens: "",
    id: ""
}

// Alterando TokenState para UserState
