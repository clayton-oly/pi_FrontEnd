        ...
        <Grid id='items-wrapper'>
          <Box id='items'>
            <figure className='item'>
              <img src='https://t.ctcdn.com.br/l3FfZefGePASotb6gaQ9dstkjaU=/1400x788/smart/filters:format(webp)/i451008.jpeg' className='imagem_banner' />
              <figcaption>
                <h2>DEATHLOOP</h2>
            ...
            <figure className='item'>
              <img src='https://image.api.playstation.com/vulcan/ap/rnd/202008/2619/aEqpsWKWYe1dxn9zKs7HgLai.jpg' className='imagem_banner' />
              <figcaption>
            ...
            <figure className='item'>
              <img src='https://meups.com.br/wp-content/uploads/2019/02/Horizon-Zero-Dawn.jpg' className='imagem_banner' />
              <figcaption>
